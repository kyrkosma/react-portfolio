    ...
    return (
        <div name='about' className='w-full h-screen bg-[#0a192f] text-white'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div className='max-w-[1000px] w-full mx-auto px-10 grid sm:grid-cols-2'>
                    <p className='text-4xl font-bold p-4 md:text-right'>Hi, I'm Marios. <br/> Nice to meet you. <br/> Please take a look around.</p>
                    <div className='text-2xl p-4'>As a Software Engineer over the past years, I have contributed to high-impact projects for leading financial institutions.
